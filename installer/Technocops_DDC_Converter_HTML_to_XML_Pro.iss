...
OutputBaseFilename=Technocops_DDC_Converter_HTML_to_XML_Pro_Setup_v1.0.2
...
[Files]
Source: "..\release\portable\{#MyAppDirName}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
